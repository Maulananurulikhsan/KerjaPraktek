                                        ...
                                        ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $d['id_dept']; ?></td>
                                                        <td class="text-center"><?php echo $d['departemen']; ?></td>
                                                        <td align="center">
                                                            <a href="edit_departemen.php?id=<?php echo $d['id']; ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i>Edit</a>
                                                            <a href="delete_departemen.php?id=<?php echo $d['id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i>Delete</a>
                                                        </td>
                                                    </tr>
                                            <?php
                                            }
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Data Departemen</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="insert_departemen.php" method="post" class="form-user" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="control-label" for="id_dept">Id Departemen</label>
                            <input type="text" name="id_dept" id="id_dept" class="form-control" required>
                        </div>
                        <div class="form-group">
