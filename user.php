                                        ...
                                        ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><img class="img-profile rounded-circle" src="assets/img/profile/<?php echo $d['image']; ?>" style="width: 80px;"></td>
                                                        <!-- <td class="text-center"><?php //echo $d['password']; 
                                                                                        ?></td> -->
                                                        <td class="text-center"><?php echo $d['level']; ?></td>
                                                        <td align="center">
                                                            <a href="edit_user.php?id=<?php echo $d['id']; ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i>Edit</a>
                                                            <a href="delete_user.php?id=<?php echo $d['id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i>Delete</a>
                                                        </td>
                                                    </tr>
                                            <?php
                                            }
    ...
    <div class="modal fade" id="modalTambah" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="insert_user.php" method="post" class="form-user" enctype="multipart/form-data">
